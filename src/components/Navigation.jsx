...
//     { id: 'home', label: 'Home', },
//     { id: 'cars', label: 'Cars', },
//     { id: 'mybookings', label: 'MyBookings', },
          ...
          <div className="flex space-x-1 px-4 py-2 rounded-[2rem] bg-white border border-[#E1E1E1]">
            ...
            {navItems.map((item) => (
              <button
                ...
                className="px-4 py-2 rounded-lg font-medium transition-all duration-200 flex items-center space-x-2 text-[#414141CC] hover:bg-gray-100 hover:text-gray-800"
              >
            ...
            {/* Extra static item */}
            <span className="px-4 py-2 rounded-lg font-medium transition-all duration-200 flex items-center space-x-2 text-[#414141CC] hover:bg-gray-100 hover:text-gray-800">
              List cars
            </span>
            ...
            {!isAuthenticated ? (
              <div className="ml-3 flex items-center">
                <button
                  ...
                  className="px-4 py-1 rounded-[2rem] hover:scale-105 transition-transform font-medium flex items-center space-x-2 bg-[#333333]"
                >
                  <span className="text-white">Sign In</span>
                </button>
              </div>
              ...
              <button
                ...
                className="bg-[#2563EB] text-white px-4 py-2 rounded-[2rem] hover:bg-blue-600 transition-colors duration-200"
              >
                Sign Out
              </button>
            )}
